...
CHIP_FLOPS = {
  ...
  "NVIDIA GEFORCE GTX 1060": DeviceFlops(fp32=4.48*TFLOPS, fp16=8.96*TFLOPS, int8=17.92*TFLOPS),
  ...
  # GTX 16 series
  "NVIDIA GEFORCE GTX 1660 TI": DeviceFlops(fp32=5.44*TFLOPS, fp16=10.88*TFLOPS, int8=21.76*TFLOPS),
